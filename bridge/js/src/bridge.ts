...
export type BridgeResponse =
  | { t: 'ok'; id: number; payload: string | null; side?: number | null }
  | { t: 'err'; id: number; code: string; detail?: string | null }
 ...
 */
export const BridgeEnvelope = {
  encodeRequest(req: Omit<BridgeRequest, 't'>): BridgeRequest {
    return { t: 'req', ...req }
  },

  ok(id: number, payload: string | null = null): BridgeResponse {
    return { t: 'ok', id, payload }
  },

  err(id: number, code: string, detail?: string | null): BridgeResponse {
